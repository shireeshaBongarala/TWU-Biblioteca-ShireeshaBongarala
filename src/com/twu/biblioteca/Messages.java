...
public interface Messages {
    ...
    public String PROMPT_USER_FOR_CHECKOUT_BOOK = "Would you like to checkout a book?\n";
    ...
    public String PROMPT_USER_FOR_CHECKOUT_MOVIE = "Would you like to checkout a movie?\n";
